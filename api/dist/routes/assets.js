...
async function assetRoutes(fastify) {
    ...
    fastify.post("/", { preHandler: rateLimit_1.assetAddRateLimit }, async (request, reply) => {
        try {
    ...
    fastify.put("/:id", { preHandler: rateLimit_1.assetUpdateRateLimit }, async (request, reply) => {
        try {
